...
class Game {
    constructor() {
        ...
        this.ball2 = new Ball(canvas.width / 2, canvas.height / 2, 8, 3, 3);
        this.ball3 = new Ball(canvas.width / 2, canvas.height / 2, 15, 4, 2);
        this.ball4 = new Ball(canvas.width / 2, canvas.height / 2, 11, 1, 1);
        this.ball5 = new Ball(canvas.width / 2, canvas.height / 2, 20, 2, 1);

    }

    draw() {
        ctx.clearRect(0, 0, canvas.width, canvas.height);
        this.ball.draw('White');
        this.ball2.draw('Red');
        this.ball3.draw('Yellow');
        this.ball4.draw('Blue');
        this.ball5.draw('Green');
        
        this.paddle1.draw('green', 50);
